/* /////////////////////////////////////////////////////////////////////////
 * File:        test/scratch/test.scratch.be.zmq/test.scratch.be.zmq.cpp
 *
 * Purpose:     Implementation file for the test.scratch.be.zmq project.
 *
...
PANTHEIOS_EXTERN_C const PAN_CHAR_T PANTHEIOS_FE_PROCESS_IDENTITY[] = PSTR("test.scratch.be.zmq");
